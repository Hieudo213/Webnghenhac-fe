...
import "./PlaylistItemPage.css";
import { useParams } from "react-router-dom";
import { useNavigate } from "react-router-dom";
import { useDispatch } from "react-redux";
import { updatePlaylist, activatePlaylist } from "../../redux/apiRequest";
function PlaylistItemPage() {
  ...
  const handleSubmit = (e) => {
    ...
    updatePlaylist(Playlist, dispatch, navigate, id);
  };
  ...
  const handleActivate = (e)=>{
    e.preventDefault();
    activatePlaylist(dispatch,navigate,id);
  }
  return (
    <div id="playlist-item-page-container">
      {playlist && (
